...
public class Activity4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pregunta=findViewById(R.id.textViewPregunta4);
        respuesta1=findViewById(R.id.radioButtonP4R1);
        respuesta2=findViewById(R.id.radioButtonP4R2);
        respuesta3=findViewById(R.id.radioButtonP4R3);
    }
    public void Siguiente (View v){
        if(respuesta1.isChecked()==false && respuesta2.isChecked()==false && respuesta3.isChecked()==false){
            ...
            Intent siguiente = new Intent(this, Activity5.class);
