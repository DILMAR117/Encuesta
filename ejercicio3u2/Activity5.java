...
public class Activity5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pregunta=findViewById(R.id.textViewPregunta5);
        respuesta1=findViewById(R.id.radioButtonP5R1);
        respuesta2=findViewById(R.id.radioButtonP5R2);
        respuesta3=findViewById(R.id.radioButtonP5R3);
    ...
    public void Calificar (View v){
        if(respuesta1.isChecked()==false && respuesta2.isChecked()==false && respuesta3.isChecked()==false){
            ...
            Intent siguiente = new Intent(this, Activity6.class);
